...
namespace margelo::nitro::RNSkiaYoga {
  ...
  public:
    ...
    std::optional<std::shared_ptr<SkMatrix>> matrix     SWIFT_PRIVATE;
  ...
  struct JSIConverter<margelo::nitro::RNSkiaYoga::NodeStyle> final {
    static inline margelo::nitro::RNSkiaYoga::NodeStyle fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::RNSkiaYoga::NodeStyle(
        ...
        JSIConverter<std::optional<std::shared_ptr<SkMatrix>>>::fromJSI(runtime, obj.getProperty(runtime, "matrix")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::RNSkiaYoga::NodeStyle& arg) {
      ...
      obj.setProperty(runtime, "matrix", JSIConverter<std::optional<std::shared_ptr<SkMatrix>>>::toJSI(runtime, arg.matrix));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::shared_ptr<SkMatrix>>>::canConvert(runtime, obj.getProperty(runtime, "matrix"))) return false;
