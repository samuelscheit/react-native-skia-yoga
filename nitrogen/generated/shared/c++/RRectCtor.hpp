...
namespace margelo::nitro::RNSkiaYoga {
  ...
  /**
   * A struct which can be represented as a JavaScript object (RRectCtor).
   */
  struct RRectCtor {
  public:
    std::optional<std::variant<double, SkPoint>> r     SWIFT_PRIVATE;
  ...
  public:
    RRectCtor() = default;
    explicit RRectCtor(std::optional<std::variant<double, SkPoint>> r, std::optional<double> x, std::optional<double> y, double width, double height): r(r), x(x), y(y), width(width), height(height) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ RRectCtor <> JS RRectCtor (object)
  template <>
  struct JSIConverter<margelo::nitro::RNSkiaYoga::RRectCtor> final {
    static inline margelo::nitro::RNSkiaYoga::RRectCtor fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::RNSkiaYoga::RRectCtor(
        JSIConverter<std::optional<std::variant<double, margelo::nitro::RNSkiaYoga::SkPoint>>>::fromJSI(runtime, obj.getProperty(runtime, "r")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::RNSkiaYoga::RRectCtor& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, "r", JSIConverter<std::optional<std::variant<double, margelo::nitro::RNSkiaYoga::SkPoint>>>::toJSI(runtime, arg.r));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::variant<double, margelo::nitro::RNSkiaYoga::SkPoint>>>::canConvert(runtime, obj.getProperty(runtime, "r"))) return false;
