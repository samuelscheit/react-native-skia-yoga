...
const tmpDir = mkdtempSync(path.join(tmpdir(), "rnskia-rnsk-yoga-view-runtime-"))
...
try {
	...
	if (runResult.error) {
		throw new Error(`Failed to execute RNSkYogaView runtime binary: ${runResult.error.message}`)
	}
