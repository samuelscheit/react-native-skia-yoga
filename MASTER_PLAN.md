...
- After Worker 222, run a fresh post-implementation root-cause audit unless
  integration reveals a stronger immediate verification or repair target.
