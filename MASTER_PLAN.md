...
Latest accepted implementation: worker 171 added dynamic SkPoint-capable
`style.borderTopLeftRadius` public/Reconciler proof for SharedValue scalar,
whole point, and point-leaf authoring plus invalid-shape rejection coverage.
