...
- Worker 225 should rank remaining finite-validation gaps, especially public
  text/paragraph style numeric leaves versus dynamic `AnimatedDouble`
  mutation-time validation and raw numeric method arguments.
