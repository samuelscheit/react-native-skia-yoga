...
Latest integration: worker 153 expanded the generated materialized
`YogaNode.setStyle(...)` proof to cover SkPaint-backed `backgroundColor`,
explicit paint-field overrides, and Yoga border state through the materialized
wrapper path.
