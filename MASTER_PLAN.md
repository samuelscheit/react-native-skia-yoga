...
Latest accepted implementation: worker 179 added bounded host-native raster
evidence for global `style.borderRadius` scalar clipping through
...
- Worker 180 post-Worker 179 root-cause audit.
  - Accept or reject Worker 179's global border-radius raster proof boundary.
