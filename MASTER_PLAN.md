...
- Monitor worker 084 for bounded host-native `ImageCmd` command/render verification using a synthetic `SkImage` wrapped in a real RN Skia `JsiSkImage` host object.
