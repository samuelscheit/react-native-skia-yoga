...
- Launch and monitor worker 080 for a host-native YogaNode command/render verifier around real `YogaNode::setCommand()` and raster rendering behavior.
