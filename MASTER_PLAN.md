...
Latest integration: worker 139 added dual flat/nested `ParagraphStyle::toJSI(...)` output, preserved distinct paragraph/text-style `heightMultiplier` values, and reconfirmed the 28-command feasible matrix.
