...
Previous accepted implementation: worker 203 added same-node sequential
generated materialized coverage for Worker 199's exact remaining dynamic layout
fields: `start`, `end`, `marginLeft`, `marginRight`, and `inset`.
