...
- Launch worker 113 to address `JSIConverter<NodeCommand>::toJSI(...)` serialization symmetry without widening into platform/runtime proof or unrelated package-boundary work.
