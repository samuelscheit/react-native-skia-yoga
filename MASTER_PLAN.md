...
- Monitor active worker 068 example native-generation verifier, then accept or reject it based on its tmux goal gate, implementation/report scope, Node-run Expo CNG evidence, generated project/autolinking assertions, cleanup guarantees, proof-boundary wording, nested challenger documentation, full verification matrix, and cleanup state.
