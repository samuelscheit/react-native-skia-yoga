...
- Agent path: `/root/worker_233_post_232_root_cause_audit_retry`.
  Initial agent `/root/worker_233_post_232_root_cause_audit` stalled before
  writing a report and was closed.
...
- State: restarted with `agent_type: "worker"`, `goal: true`,
  `fork_turns: "none"`, `model: "gpt-5.5"`, and
  `reasoning_effort: "xhigh"`.
