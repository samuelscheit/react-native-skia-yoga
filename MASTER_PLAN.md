...
- Monitor `worker-047-util-lazy-nitro-box` while it fixes `src/util.ts` import-time Nitro boxing and adds broader public import-only verification that does not stub `util`.
