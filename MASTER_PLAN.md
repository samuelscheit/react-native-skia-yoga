...
Latest integration: worker 112 package export-boundary hardening accepted; worker 113 NodeCommand `toJSI(...)` serialization symmetry active.
...
- Monitor worker 113 on `JSIConverter<NodeCommand>::toJSI(...)` serialization symmetry without widening into platform/runtime proof or unrelated package-boundary work.
