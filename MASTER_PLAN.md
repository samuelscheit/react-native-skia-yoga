...
- Launch worker 118 as a read-only post-worker-117 root-cause audit with `spawn_agent`, using an isolated worktree and the new `WORKER_BRIEF.md` worker model.
